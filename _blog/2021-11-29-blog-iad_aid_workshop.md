...
TErrestrial Trunked RAdio (TETRA) is a standard by ETSI is recommended as a dependable system for communications in natural disasters (see book on Early Warning Sytems)
...
The IETF is one of the main Internet governance bodies and it is therefore pressing to ask what its role ought to be, can be, and currently is with respect to the climate crisis.
